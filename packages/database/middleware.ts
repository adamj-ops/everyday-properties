...
/**
 * Database context middleware for RLS (Row Level Security)
 * This middleware sets the database context for each request to ensure
 * proper multi-tenant isolation and user-specific access control.
 */
